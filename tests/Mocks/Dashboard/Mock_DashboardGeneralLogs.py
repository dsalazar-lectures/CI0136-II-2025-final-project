...
class MocksDashboardGeneralLogs:
    ...
    def patch_show_general_logs_window_valid():
        ...
        return (
            ...
            patch.object(GeneralData_Window, "load_logs_from_json", return_value=fake_df),
            patch("src.Services.Metrics.DashboardGeneralLogs.GeneralLogs.show_kpis"),
            patch("src.Services.Metrics.DashboardGeneralLogs.GeneralLogs.show_general_charts"),
            patch("src.Services.Metrics.DashboardGeneralLogs.GeneralLogs.show_logs_table"),
        )
    ...
    def patch_sidebar_select_files_valid():
        return patch("src.Services.Metrics.DashboardGeneralLogs.st.sidebar.multiselect", return_value=[Path("file1.json")])

    @staticmethod
    def patch_sidebar_select_files_empty():
        return (
            patch("src.Services.Metrics.DashboardGeneralLogs.st.sidebar.multiselect", return_value=[]),
