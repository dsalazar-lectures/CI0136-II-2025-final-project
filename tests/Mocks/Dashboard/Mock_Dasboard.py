...
class TestLogsDashboard(unittest.TestCase):
    ...
    @patch("Metrics.Dashboard.st.warning")
    @patch("Metrics.Dashboard.Path.glob")
    @patch("Metrics.Dashboard.Path.exists")
    ...
    @patch("Metrics.Dashboard.st.sidebar.selectbox")
    ...
    @patch("Metrics.DashboardGeneralLogs.GeneralData_Window.show_general_logs_window")
    @patch("Metrics.DashboardAnalysisLogs.Analysis_Window.show_analysis_logs_window")
    ...
    @patch("Metrics.Dashboard.st.subheader")
    @patch("Metrics.Dashboard.st.info")
