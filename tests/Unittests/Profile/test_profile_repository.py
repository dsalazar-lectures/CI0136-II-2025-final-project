...
class TestProfileRepository(unittest.TestCase):
    ...
    def setUp(self):
        self.temp_file = tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='_test_profiles.csv')
    ...
    def test_create_profile_returns_none_on_failure(self):
        ...
        with unittest.mock.patch.object(self.profile_repo.profile_database, 'create_profile', return_value=None):
            result = self.profile_repo.create_profile(1)
