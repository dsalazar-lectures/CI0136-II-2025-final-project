...
class TestCSVRecipeRepositoryAPIIntegration(unittest.TestCase):
    ...
    def test_get_all_combines_system_and_api(
        ...
        with patch.object(CSVRecipeRepository, "get_all") as mock_get_all:
    ...
    def test_get_by_id_searches_both_sources(self, mock_load_recipes, mock_load_api):
        ...
        with patch(
            "src.Infrastructure.Recipes.CSVRecipeRepository.system_recipes",
            self.mock_system_recipes,
        ):
            with patch(
                "src.Infrastructure.Recipes.CSVRecipeRepository.api_recipes",
                self.mock_api_recipes,
            ):
    ...
    @patch("src.Infrastructure.Recipes.CSVRecipeRepository.load_api_recipes")
    @patch("src.Infrastructure.Recipes.CSVRecipeRepository.load_recipes")
    def test_case_insensitive_ingredient_search(self, mock_load_recipes, mock_load_api):
    ...
    @patch("src.Infrastructure.Recipes.CSVRecipeRepository.load_api_recipes")
    @patch("src.Infrastructure.Recipes.CSVRecipeRepository.load_recipes")
    def test_case_insensitive_category_search(self, mock_load_recipes, mock_load_api):
